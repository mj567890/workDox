...
TOOLS = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "列出文档库中的所有文档。用于回答'有哪些文档'、'库里有多少文档'等问题。",
            "parameters": {
                "type": "object",
                "properties": {
                    "status": {
    ...
    },
    {
        ...
        "function": {
            ...
            "description": (
                "获取指定文档的详细信息，包括文件类型、大小、状态、分类、标签、版本等。"
                "用于回答'某个文档的详细信息'、'doc_id为X的文档是什么'等问题。"
            ),
            "parameters": {
                "type": "object",
                "properties": {
...
async def _get_document_detail(db: AsyncSession, args: dict) -> str:
    ...
    sql = text(
        ...
        "COALESCE(d.extracted_text IS NOT NULL AND length(d.extracted_text) > 0, false) as has_text2 "
        "FROM document d "
